import 'package:ecommerce/Screen/bottomNavbar.dart';
import 'package:ecommerce/auth/login.dart';
import 'package:ecommerce/service/database.dart';
import 'package:ecommerce/service/sharedPrefernce.dart';
  ...
  registration() async {
    if (password != null) {
      try {
        ...
        await DatabaseMethods().addUsersDetails(addUserInfo, Id);
